...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/posts/{id}/tags").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.PUT, "/posts/{id}/*").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.POST, "/tags").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/tags/{name}").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.PUT, "/tags/{name}").hasAuthority("ADMIN")
